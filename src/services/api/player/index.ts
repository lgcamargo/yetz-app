...
import { BalancedPlayers, CreatePlayer, Player } from "./types";
...
export const balancedPlayersRoute = (balancedPlayers: BalancedPlayers): Promise<Guild[]> => 
  apiClient.post(`/player/balanced`, balancedPlayers).then(response => response.data as Guild[]);
